...
function initTable() {
    ...
    columns: [{field: 'state', checkbox: true, align: 'center', valign: 'middle',}, 
            ...
            { field: 'role', title: 'Vai trò', align: 'center', valign: 'center', sortable: true, },
            { field: 'category', title: 'Chuyên mục', align: 'center', valign: 'center', }],
        data: [{ "id": 1, "name": "Người dùng 1", "date": "1-1-2000", 'role': 'đọc giả',  },
            ...
            { "id": 5, "name": "Người dùng 5",  "date": "18-9-1985", 'role': 'biên tập viên', 'category': 'Công nghệ'},
            ...
            { "id": 9, "name": "Người dùng 9",  "date": "1-1-1992", 'role': 'biên tập viên', 'category': 'Thế giới'},
            ...
            { "id": 15, "name": "Người dùng 15",  "date": "25-1-1991", 'role': 'biên tập viên', 'category': 'Sức khỏe'},
